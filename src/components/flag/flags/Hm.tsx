  ...
  return (
    <svg width={15} height={15} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" {...props}>
      <defs>
        ...
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="hm_svg__e">
          <stop stopColor="#DB1E36" offset="0%" />
          <stop stopColor="#D51931" offset="100%" />
        </linearGradient>
        <path id="hm_svg__b" d="M0 0h10v8H0z" />
      </defs>
      <g fill="none" fillRule="evenodd">
        <path fill="url(#hm_svg__a)" d="M0 0h15v15H0z" />
        <mask id="hm_svg__d" fill="#fff">
          <use xlinkHref="#hm_svg__b" />
        </mask>
        <path
        ...
        <path
          ...
          mask="url(#hm_svg__d)"
        />
        <path fill="url(#hm_svg__e)" mask="url(#hm_svg__d)" d="M0 3h4V0h1v3h4v1H5v3H4V4H0z" />
        <path
