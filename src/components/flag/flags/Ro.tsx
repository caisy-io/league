  ...
  return (
    <svg width={15} height={15} xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <g fill="none" fillRule="evenodd">
        <path fill="url(#ro_svg__a)" d="M0 0h15v15H0z" />
        <path fill="url(#ro_svg__b)" d="M7 0h8v15H7z" />
        <path fill="url(#ro_svg__c)" d="M0 0h5v15H0z" />
        <path fill="url(#ro_svg__d)" d="M5 0h5v15H5z" />
      </g>
    </svg>
  );
}
