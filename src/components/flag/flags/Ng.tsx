  ...
  return (
    <svg width={15} height={15} xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <g fill="none" fillRule="evenodd">
        <path fill="url(#ng_svg__a)" d="M0 0h15v15H0z" />
        <path d="M7.143 0H15v15H7.143V0zM0 0h5v15H0V0z" fill="url(#ng_svg__b)" fillRule="nonzero" />
        <path fill="url(#ng_svg__a)" d="M5 0h5v15H5z" />
      </g>
    </svg>
  );
}
