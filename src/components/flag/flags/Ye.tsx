  ...
  return (
    <svg width={15} height={15} xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <g fill="none" fillRule="evenodd">
        <path fill="url(#ye_svg__a)" d="M0 0h15v15H0z" />
        <path fill="url(#ye_svg__b)" d="M0 0h15v5H0z" />
        <path fill="url(#ye_svg__c)" d="M0 10h15v5H0z" />
        <path fill="url(#ye_svg__a)" d="M0 5h15v5H0z" />
      </g>
    </svg>
  );
}
