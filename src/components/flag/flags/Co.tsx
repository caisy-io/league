  ...
  return (
    <svg width={15} height={15} xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <g fill="none" fillRule="evenodd">
        <path fill="url(#co_svg__a)" d="M0 0h15v15H0z" />
        <path fill="url(#co_svg__b)" d="M0 7h15v4H0z" />
        <path fill="url(#co_svg__c)" d="M0 11h15v4H0z" />
        <path fill="url(#co_svg__d)" d="M0 0h15v7H0z" />
      </g>
    </svg>
  );
}
