...
function OrganizationMenuDemo({ content, ...args }) {
  return <OrganizationMenu>
    ...
    <SelectionWrapper>
      <OrganizationMenuListItem itemSize="medium" badgeValue="3"><Badge value="1" position={EBadgePosition.Center} type={'regular'} size="small"></Badge></OrganizationMenuListItem>
