...
// TODO make this file to tsx file, add puppeteer to tools to fix imports
import { puppet, PuppeteerBreak } from '../../utils/tools/Puppeteer';
...
export const Poppable = forwardRef(({children, container, reference, placements, default: _default, onPlacement, placement, overflow, className, style, ...props}: IPoppable, ref) => {
    const target = useRef();
    ...
    return (
        <SPoppable>
            <PuppeteerBreak namespace='poppable'>
                <Stackable 
                    {...props} 
