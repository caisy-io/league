    ...
    <SCheckbox >
      <SCustomCheckbox checked={isChecked} loading={loading}>
        ...
        <svg width="6" height="6" viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0.62793 3.22613L2.0732 4.6714L2.06386 4.66206L5.32455 1.40137" stroke="white" stroke-width="1.2" stroke-dasharray="200" stroke-dashoffset="200" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
